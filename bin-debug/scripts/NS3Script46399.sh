...
Time::SetResolution (Time::NS);
  ...
  NodeContainer c = NodeContainer ( computer_1, switchOpenflow_2, computer_)
  ...
  UdpEchoClientHelper echoClient0 (iface_switchOpenflow_2_computer_1.GetAddress (1), 9);
  ...
  UdpEchoClientHelper echoClient1 (iface_computer_3_switchOpenflow_2.GetAddress (1), 9);
