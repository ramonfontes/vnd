...
Time::SetResolution (Time::NS);
  ...
  int32_t ifIndexcomputer_3ipv4computer_3->AddInterface (Devicecomputer_3);


  NS_LOG_INFO ("Building links.");
  CsmaHelper csma_bridge_2_3;
  csma_bridge_2_3.SetChannelAttribute ("DataRate", StringValue ("2"));
  csma_bridge_2_3.SetChannelAttribute ("Delay", StringValue ("2"));
  CsmaHelper csma_bridge_1_2;
  csma_bridge_1_2.SetChannelAttribute ("DataRate", StringValue ("1"));
  csma_bridge_1_2.SetChannelAttribute ("Delay", StringValue ("1"));
  ...
  Ipv4InterfaceContainer iface_switchOpenflow_2_computer_3 = address.Assign (ndc_p2p3);
