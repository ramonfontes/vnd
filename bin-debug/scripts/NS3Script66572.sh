...
Time::SetResolution (Time::NS);
  ...
  csma_bridge_3_2.SetChannelAttribute ("DataRate", StringValue ("2"));
  csma_bridge_3_2.SetChannelAttribute ("Delay", StringValue ("2"));
  CsmaHelper csma_bridge_2_1;
  csma_bridge_2_1.SetChannelAttribute ("DataRate", StringValue ("1"));
  csma_bridge_2_1.SetChannelAttribute ("Delay", StringValue ("1"));
  ...
  NodeContainer all_switchOpenflow_2_computer_1;
  all_switchOpenflow_2_computer_1.Add (switchOpenflow_2);
  all_switchOpenflow_2_computer_1.Add (computer_1);
  NetDeviceContainer ndc_p2p1 = csma_bridge_2_1.Install (all_switchOpenflow_2_computer_1);

  NS_LOG_INFO ("PCAP CONFIGURATION.");
  csma_bridge_3_2.EnablePcapAll("all_computer_3_switchOpenflow_2");
  csma_bridge_2_1.EnablePcapAll("all_switchOpenflow_2_computer_1");
  ...
  Ipv4InterfaceContainer iface_switchOpenflow_2_computer_1 = address.Assign (ndc_p2p1);
  ...
  UdpEchoClientHelper echoClient1 (iface_switchOpenflow_2_computer_1.GetAddress (1), 9);
