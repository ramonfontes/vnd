...
Time::SetResolution (Time::NS);
  ...
  ipv4computer_1->AddAddress (ifIndexcomputer_1, ifInAddrcomputer_1);
  ipv4computer_1->SetMetric (ifIndexcomputer_1, 1);
  ipv4computer_1->SetUp (ifIndexcomputer_1);
  ...
  Ptr<Ipv4> ipv4computer_2 = computer_2->GetObject<Ipv4> ();
  int32_t ifIndexcomputer_2 = ipv4computer_2->AddInterface (Devicecomputer_2);

  Ipv4InterfaceAddress ifInAddrcomputer_2 = Ipv4InterfaceAddress (Ipv4Address ("10.0.0.2"), Ipv4Mask ("255.0.0.0"));
  ipv4computer_2->AddAddress (ifIndexcomputer_2, ifInAddrcomputer_2);
  ipv4computer_2->SetMetric (ifIndexcomputer_2, 1);
  ipv4computer_2->SetUp (ifIndexcomputer_2);
