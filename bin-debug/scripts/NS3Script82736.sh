...
Time::SetResolution (Time::NS);
  ...
  Ptr<Ipv4> ipv4computer_1GetObject<Ipv4> ();
  int32_t ifIndexcomputer_1ipv4computer_1AddInterface (Devicecomputer_1);
  ...
  Ptr<Ipv4> ipv4computer_2GetObject<Ipv4> ();
  int32_t ifIndexcomputer_2ipv4computer_2AddInterface (Devicecomputer_2);
