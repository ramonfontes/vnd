...
Time::SetResolution (Time::NS);
  ...
  NodeContainer c = NodeContainer ( computer_1, switchOpenflow_2, computer_3 );
  ...
  Ptr<Ipv4> ipv4computer_1 = computer_1->GetObject<Ipv4> ();
  int32_t ifIndexcomputer_1 = ipv4computer_1->AddInterface (Devicecomputer_1);

  Ipv4InterfaceAddress ifInAddrcomputer_1 = Ipv4InterfaceAddress (Ipv4Address (10.0.0.1), Ipv4Mask (255.0.0.0));
  ipv4A->AddAddress (computer_1, computer_1);
  ipv4A->SetMetric (computer_1, 1);
  ipv4A->SetUp (computer_1);
  ...
  switchOpenflow_2->AddDevice (DeviceswitchOpenflow_2);

  Ptr<CsmaNetDevice> Devicecomputer_3 = CreateObject<CsmaNetDevice> ();
  Devicecomputer_3->SetAddress (Mac48Address::Allocate ());
  computer_3->AddDevice (Devicecomputer_3);
  Ptr<Ipv4> ipv4computer_3 = computer_3->GetObject<Ipv4> ();
  int32_t ifIndexcomputer_3 = ipv4computer_3->AddInterface (Devicecomputer_3);

  Ipv4InterfaceAddress ifInAddrcomputer_3 = Ipv4InterfaceAddress (Ipv4Address (10.0.0.3), Ipv4Mask (255.0.0.0));
  ipv4A->AddAddress (computer_3, computer_3);
  ipv4A->SetMetric (computer_3, 1);
  ipv4A->SetUp (computer_3);

  NS_LOG_INFO ("Building links.");


  NS_LOG_INFO ("Building link net device container.");
  NodeContainer all_switchOpenflow_2_computer_3;
  all_switchOpenflow_2_computer_3.Add (switchOpenflow_2);
  all_switchOpenflow_2_computer_3.Add (computer_3);
  NetDeviceContainer ndc_p2p3 = csma_bridge_2_3.Install (all_switchOpenflow_2_computer_3);
  ...
  csma_bridge_2_3.EnablePcapAll("all_switchOpenflow_2_computer_3");
  ...
  UdpEchoClientHelper echoClient0 (iface_switchOpenflow_2_computer_3.GetAddress (1), 9);
